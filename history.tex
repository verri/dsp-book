...
laid out.  These advancements enabled methods beyond summary statistics, bringing to life
the field of statistical inference.

\subsubsection{Learning from data}

In the nineteenth century, new advances were made in the field of statistics.  The
development of statistical learning methods, such as the method of least squares, enabled
the development of new techniques for data analysis.

Vapnik and Chervonenkis (1971) proposed the first learning model based on statistical
