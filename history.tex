...
\def\firstcircle{(0,0) circle (20mm)}
\def\secondcircle{(0:5mm) circle (15mm)}
\def\thirdcircle{(0:40mm) circle (15mm)}
...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \end{scope}
    \draw[outline] \firstcircle node(ds) {};
    \draw[outline] \secondcircle node {computer science};
    \draw[outline] \thirdcircle node {domain expertise};
