...
Although punched cards were used as early as 1725 by Basile Bouchon {\color{red} verify
information} to control looms, I could not find any hystorical device that automatically
collected data from sensors and stored in punched cards.  In 1890, Herman Hollerith used
punched cards to tabulate the 1880 census {\color{red} verify information}.
Hollerith's invention eventually led to the founding of the Tabulating Machine Company in
1896, which later merged with other companies to become International Business Machines
Corporation (IBM) in 1924. The punched card technology remained a prevalent method of data
processing for several decades until more advanced electronic computers were developed in
the mid-20th century.

In 1937,
George Stibitz used punched cards to send data from New York to his Complex Number
Calculator in Hanover {\color{red} verify information}. The first device that collected
data from sensors and stored in magnetic tape was the IBM 7700 Data Acquisition System
(1965) {\color{red} verify information}.  It was a general-purpose data acquisition system
that could be programmed to collect data from a variety of sources.  It was used in
scientific and industrial applications.  NASA used it to collect data from the Apollo
missions.

The probable first example of data collection in the digital age is the US Census Bureau.
The Census Bureau is the leading source of quality data about the nation's people and economy.
It is the only source of data for the official statistical information about the
characteristics of the population and housing.  The first census was conducted in 1790.
The first computerized census was conducted in 1960 {\color{red} verify information and
provide more details}.

\begin{mainbox}{Digital age}
  \begin{itemize}
    \item Hollerith's tabulating machine (1890)
    \item ENIAC (1945)
    \item IBM 7700 Data Acquisition System (1965)
    \item US Census Bureau (1960)
  \end{itemize}
\end{mainbox}
...
the concept of a relational model for database management {\color{red} verify information and
provide more details}.
