...
{
  \footnotesize\noindent\color{red}
  \textbf{Disclaimer:} This version is a work in progress.  Parts of the book have
  been drafted with the help of \href{https://github.com/features/copilot}{GitHub Copilot}
  and may not be revised yet by the author.  Proofreading and professional editing are
  still pending.
}
...
{
\footnotesize\noindent
The book is typeset with \XeTeX{} using the \texttt{memoir} class.  All figures are
original and created with \texttt{TikZ}.  Proudly written in
...
We use the beautifule \href{https://www.stixfonts.org/}{STIX fonts} for text and math.
}
