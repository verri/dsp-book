...
\begin{titlingpage}
  \begin{tikzpicture}[remember picture, overlay]
    \node[anchor=south east, inner sep=8mm] at (current page.south east) {%
      \reflectbox{\includegraphics[height=0.6\paperheight]{images/toucan.png}}%
    };
    \node[anchor=south east, inner sep=10mm] at (current page.south east) {\large\sffamily\textcolor{black!60}\today};
    \node[anchor=north, yshift=-20mm](title) at (current page.north) {\HUGE\sffamily\uppercase{Data science}};
    \node[anchor=north, inner sep=5mm] at (title.south) {\LARGE\sffamily\uppercase{foundations and practices}};
...
{
\footnotesize\noindent
Book cover image was created with the assistance of \href{https://openai.com/dall-e-2}{DALL·E 2}.
}
