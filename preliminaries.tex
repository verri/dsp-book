...
\[
  \left\lceil \frac{n}{2^{i-1}} \right\rceil = 1 \implies
  i = 1 + \left\lfloor \log n \right\rfloor\text{.}
\]
...
\begin{figurebox}[label=fig:sudoku]{Backtracking to solve a Sudoku puzzle.}
  ...
  backtracking steps.  Invalid tries and the constraints violated are shown in gray.
\end{figurebox}
