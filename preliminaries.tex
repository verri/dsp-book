...
Divide and conquer algorithms are usually implemented using recursion.  \emph{Recursion}
is a programming technique where a function calls itself to solve smaller instances of the
...
As an example, \cref{alg:bsearch} has a worst-case time complexity of $O(\log n)$, where
