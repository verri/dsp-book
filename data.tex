...
quantified in some way\footnote{%
  ...
  data science.  However, they may be the object of study in other sciences, such as
...
and the models that can explain them, in data science the objects of the study in data
...
it is useful to understand data science as a new science.
