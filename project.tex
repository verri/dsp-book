...
great changes in the initial requirements and goals of the project.
...
based on input and output examples  ---, and \cref{chap:planning} cover
...
\begin{figure}
  ...
  \end{tikzpicture}
  \caption{
  Tasks and results for each sprint types and their relationships.
  Summary of the tasks and results for each sprint type and their relationships.
  }
  \label{fig:our-sprints}
\end{figure}
...
(The lead data scientist approve the results in the absence of the business spokesman.)
