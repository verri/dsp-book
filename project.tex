...
data science projects have exploratory phases, which are not well supported by Scrum.
...
In order to avoid confusion, the user interface must mask data-science-specific
...
In most cases, the model loses performance over time, usually caused by changes in
...
Unless the application is known to be very challenging, projects should start with simple methods
