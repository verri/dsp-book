...
\begin{table}
  ...
  \label{tab:student-grade-illustration}
\end{table}
...
\begin{table}
  ...
  \end{tabular}
  \caption{
  Student grade relation in 3NF.
  An example of a relation of students and their grades in 3NF.
  }
  \label{tab:student-grade-illustration2}
\end{table}
...
\end{itemize}
\Cref{tab:tidy} summarizes the main concepts.
...
\begin{table}
  ...
  \begin{tabular}{l r r r c}
    ...
    \bottomrule
  \end{tabular}
  \caption{Messy table, from Pew Forum dataset, where headers are values, not variable names.}
  \label{tab:messy1}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{l l r}
    ...
    \bottomrule
  \end{tabular}
  \caption{Tidy version of \cref{tab:messy1} where values are correctly moved.}
  \label{tab:tidy1}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{l l l r c}
    ...
    \bottomrule
  \end{tabular}
  \caption{Messy table, from TB dataset, where multiple variables are stored in one column.}
  \label{tab:messy2}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{l l l l r c}
    ...
    \bottomrule
  \end{tabular}
  \caption{Tidy version of \cref{tab:messy2} where values are correctly moved.}
  \label{tab:tidy2}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{llllcccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Messy table, adapted from molten weather dataset, where variables are stored in both rows and columns.}
  \label{tab:messy3}
\end{table}
...
\begin{table}
  ...
  \end{tabular}
  \caption{
    Partial solution to tidy \cref{tab:messy3}. Note that the table is now longer.
  }
  \label{tab:tidy3a}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{llcc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Tidy version of \cref{tab:messy3} where values are correctly moved.}
  \label{tab:tidy3b}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{lllll}
    ...
    \bottomrule
  \end{tabular}
  \caption{Messy table, adapted from billboard dataset, where multiple types of observational units are stored in the same table.}
  \label{tab:messy4}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{lll}
    ...
    \bottomrule
  \end{tabular}
  \caption{Tidy version of \cref{tab:messy4} containing the observational unit \emph{track}.}
  \label{tab:tidy4a}
\end{table}
...
\begin{table}
  ...
  \end{tabular}
  \caption{
    Tidy version of \cref{tab:messy4} containing the observational unit \emph{rank of the
    track in certain week}.
  }
  \label{tab:tidy4b}
\end{table}
...
\begin{table}
  ...
  \end{tabular}
  \caption{
    Messy tables, adapted from nycflights13 dataset, where a single observational unit is
    stored in multiple tables.  Assume that the origin filename is called
    \texttt{2013.csv}.
  }
  \label{tab:messy5a}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{lllll}
    ...
    \bottomrule
  \end{tabular}
  \caption{Tidy data where \cref{tab:messy5a,tab:messy5b} are combined.}
  \label{tab:tidy5}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{lllc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Tidy data where the observational unit is the event of measuring the temperature.}
  \label{tab:temp1}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{llccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Tidy data where the observational unit is the temperature at some time.}
  \label{tab:temp2}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{lccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Tidy data for measuments of a person body.}
  \label{tab:body1}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{llc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Another tidy data for measurements of a person body.}
  \label{tab:body2}
\end{table}
...
\begin{figure}
  ...
  \end{tikzpicture}
  \caption{
    Decomposition trees for the relation $R[ABCDE]$ and the functional dependencies $A \to
    D$, $B \to E$, and $AB \to C$ to reach 3NF.
  }
  \label{fig:decomp}
\end{figure}
...
\begin{figure}
  ...
  \end{tikzpicture}
  \caption{
  Invalid decomposition trees for the relation $R[ABCDE]$.
...
\begin{table}
  ...
  \end{tabular}
  \caption{
  Example of a dataset where the observational unit is the student.
