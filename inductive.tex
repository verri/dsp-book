...
We can guarantee uniform convergence the basis of the VC entropy.  Let $H^\Theta(n)$ be
...
\begin{equation}
  ...
  \lim_{n \to \infty} \frac{H^\Theta(n)}{n} = 0\text{.}
\end{equation}
...
% TODO: explain VC entropy for binary and real-valued functions
