...
\end{equation*}
where the first term is known as the explained variance and the second term, as the
unexplained variance.  The equality $R(r) = \Var\!\left(\E\!\left[y \mid x\right]\right)$
