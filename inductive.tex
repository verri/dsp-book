...
\begin{figurebox}[label=fig:vc-sin]{High-frequency sine wave functions have infinite VC dimension.}
  ...
  \end{tikzpicture}
  \tcblower
  High-frequency sine wave approximate well any set of points even though they come from a
...
parameters but with a finite VC dimension.  % TODO: discuss non-parametric here?
