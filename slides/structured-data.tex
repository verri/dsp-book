...
\begin{frame}{Limitations of Stevens' types}
  \begin{itemize}
    ...
    \item Example: age as integer or float? Valid range 100 or 120?
...
\begin{frame}{Example: 2NF vs 3NF}
  2NF (redundant ``department head'', transitive dependency):
  ...
  \begin{tabular}{ccc}
    \toprule
    \textbf{Employee} & \textbf{Department} & \textbf{Dept.\ head} \\
    \midrule
  ...
  \begin{tabular}{cc}
    \toprule
    \textbf{Department} & \textbf{Dept.\ head} \\
    \midrule
    Engineering & Eve \\
    Marketing & Frank \\
    \bottomrule
...
\begin{frame}{Tidy data}
  A standardized way to organize data values\footfullcite{Wickham2014}:
  \begin{itemize}
