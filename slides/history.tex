...
\begin{frame}{Peter Naur (1928--2016)}
  \begin{itemize}
    ...
    \item Coined ``data science'' in the 1960s
...
\begin{frame}{William Cleveland (born 1943)}
  \begin{itemize}
    ...
    \item Used ``data science'' in 2001 to name a new discipline
...
\begin{frame}{Pre-digital age}
  \begin{itemize}
    \item Lebombo bone ($\sim$40,000 years old) --- earliest tally stick
    \item First known census: 3,800 BC, Babylonian Empire
    \item Sumerian archaic writing ($\sim$3,500 BC) --- recording transactions
...
\begin{frame}{Formal age}
  \begin{itemize}
    ...
    \item Data organized in tables (relations); rows = records, columns = attributes
...
\begin{frame}{Ubiquitous age --- Technologies}
  \begin{itemize}
    ...
    \item \textbf{Cutting \& Cafarella} --- Apache Hadoop (2006), HDFS, MapReduce
...
\begin{frame}{Bayes' rule}
  \begin{itemize}
    ...
    \item Foundation of \textbf{learning from evidence}
...
\begin{frame}{Gauss' method of least squares}
  \begin{itemize}
    ...
    \item Developed circa 1794 for calculating the orbit of Ceres
...
\begin{frame}{Playfair's data visualization}
  \begin{itemize}
    ...
    \item Invented line, area, bar chart, pie chart, circle graph
...
\begin{frame}{Fisher's discriminant analysis (1930s)}
  \begin{itemize}
    ...
    \item Linear functions to separate classes of objects
...
\begin{frame}{Shannon's information theory (1940s)}
  \begin{itemize}
    ...
    \item Quantification, storage, and communication of information
...
\begin{frame}{K-Nearest Neighbors (1951)}
  \begin{itemize}
    ...
    \item Non-parametric method for classification and regression
...
\begin{frame}{Rosenblatt's perceptron (1960s)}
  \begin{itemize}
    ...
    \item First model of a \textbf{learning machine}
...
\begin{frame}{Hunt's inducing trees (1966)}
  \begin{itemize}
    ...
    \item Precursor of Quinlan's ID3 algorithm
...
\begin{frame}{Tukey's exploratory data analysis (1977)}
  \begin{itemize}
    ...
    \item Philosophy: data analysis should include open-ended exploration
  \end{itemize}
\end{frame}
...
\begin{frame}{Empirical risk minimization (1960s--1980s)}
  \begin{itemize}
    ...
    \item VC entropy and VC dimension (1968)
...
\begin{frame}{Resurgence of neural networks (1986)}
  \begin{itemize}
    \item \textbf{Backpropagation} developed independently by several researchers
...
\begin{frame}{Ensembles (1990s)}
  \begin{itemize}
    ...
    \item \textbf{Boosting} --- sequential, correcting previous errors
    \item \textbf{Bagging} --- parallel, trained with small data variations
    \item Random forests (Ho, 1995) --- bagging
    \item XGBoost (Friedman, 2001) --- gradient boosting
  \end{itemize}
\end{frame}

\begin{frame}{Support vector machines (1995)}
  \begin{itemize}
    \item \textbf{Cortes \& Vapnik} --- based on VC theory and ERM principle
    \item Finds optimal separating hyperplane with maximum margins
    \item Uses Cover's theorem (high-dimensional mapping)
...
\begin{frame}{Deep learning (late 2000s)}
  \begin{itemize}
    ...
    \item \textbf{Bengio, Hinton, LeCun} --- 2018 Turing Award
  \end{itemize}
\end{frame}

\begin{frame}{LUSI learning theory (2010s)}
  \begin{itemize}
    \item \textbf{Vapnik} --- Learning Using Statistical Invariants
...
\begin{frame}{Large Language Models (2017--)}
  \begin{itemize}
    \item \textbf{Vaswani et al.} (2017) --- transformer architecture
    \item Attention mechanisms replace recurrence and convolution
    \item Enabled development of LLMs
    \item OpenAI's ChatGPT (2020) --- wide public availability
