...
\begin{frame}{Definitions in the literature}
  \begin{itemize}
    \item \textbf{Zumel \& Mount:}\footfullcite{Zumel2019} cross-disciplinary practice drawing on data
      engineering, statistics, data mining, ML, and predictive analytics
    \item \textbf{Wickham \& Grolemund:}\footfullcite{Wickham2023} discipline that transforms raw data into
      understanding, insight, and knowledge
    \item \textbf{Hayashi:}\footfullcite{Hayashi1998} not only unifies statistics and data analysis, but
...
\begin{frame}{Reasoning}
  \begin{itemize}
    \item \textbf{Deductive reasoning} --- from general rules to general conclusions
