...
\begin{mainbox}{A note about fixed parameters}
...
\begin{mainbox}{A note about ``filtering'' operations}
...
\begin{mainbox}{Clamping after rescaling}
...
better with it}.  By doing so, the model can learn the importance of the missing data.
