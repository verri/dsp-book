...
The last important operation for us is\dots
...
\begin{itemize}
  \item Binding columns can be expressed as a join operation, thus it is not a basic
    operation.
  \item Some software provide features that can be better expressed in other ways.  Row
  ...
  \item \textcolor{red}{Pivoting is just a variation of joins?}
\end{itemize}
