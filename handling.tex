...
\begin{defbox}{Filtering operation}{filtering}
  ...
  ((\domainof{h} \cup \{?\}) \times \dots : h \in H) \to \{0, 1\}$ is applied to the value
...
\begin{defbox}{Mutating operation}{mutating}
  ...
  \] where $T' = (K, H \cup \{ h' \}, c')$ and \[
    ...
    \end{dcases}
  \] where function $f : (\domainof{K_i} \times \dots : K_i \in K ) \times ((\domainof{h}
  \cup \{?\}) \times \dots : h \in H) \to \domainof{h'} \cup \{?\}$ is applied to the
