...
\begin{itemize}
  ...
  \item Multiple types of observational units are stored in the same table; and % [normalization problem]
...
different year, one can create a new column \code{year} that contains the year of the
...
\begin{tablebox}[label=tab:gas-usage-br]{Gas usage datasets from Brazil residents.}
  \centering
  \rowcolors{2}{black!10!white}{}
  \begin{tabular}{cccc}
    \toprule
