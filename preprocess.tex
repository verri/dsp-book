...
\begin{table}\caption{Range check preprocessing task.}
  \centering
  \begin{tabular}{lp{6cm}}
    \toprule
...
\begin{table}\caption{One-hot encoding preprocessing task.}
  \centering
  \begin{tabular}{lp{6cm}}
    \toprule
...
\begin{table}\caption{Data enhancement preprocessing task.}
  \centering
  \begin{tabular}{lp{6cm}}
    \toprule
