...
$x = c$.  One-hot encoding is the process of creating a new column for each possible value
...
recommend \citeauthor{Jurafsky2008}\footnote{\fullcite{Jurafsky2008}. A new edition is
