...
concept: data.  In this book, I focus on \gls{structureddata}, which are data that are organized
...
\begin{mainbox}{Chapter remarks}
  ...
  \begin{itemize}
    ...
    \item \Gls{structureddata} are data that are organized in a tabular format.
  \end{itemize}
...
I find the first definition too restrictive since new methods and techniques are always
...
``extracting non-obvious and useful patterns from large datasets [\dots]; capturing,
...
importance of the object of study in our society.  Many say that ``data are the new oil.''
...
A phenomenon is a term used to describe any observable event or process.  They are the
...
we can classify it.  In particular, \gls{ontology} describes the nature of categories,
properties, and relations.

Aristotle (384 -- 322 BC) is one of the first philosophers to study \gls{ontology}. In
...
What is the importance of \gls{ontology} for data science?  Describing, which is basically
...
of epistemology, \gls{ontology}, and logic, and particular knowledge of the domain of
expertise.
...
epistemology, \gls{ontology}, and logic.  For example, we can use a computer to perform
...
As discussed before, knowledge and reasoning are important aspects of data science.
...
requirements of the technique, we may perform \gls{datapreprocessing}\footnote{%
  ...
  useful to perform \gls{datapreprocessing} to adjust data as much as possible.%
}.

\Gls{datapreprocessing} mainly includes data cleaning, data transformation, and data
