...
The ZM approach is particularly interesting in consulting projects, where the data scientist
is not part of the organization, or even in internal projects of organizations with a
strongly hierarchical structure.  Like CRISP-DM, the ZM approach does not directly address the
software development aspects of the project.
...
automatically, such as Quarto\footnote{\url{https://quarto.org/}}.
